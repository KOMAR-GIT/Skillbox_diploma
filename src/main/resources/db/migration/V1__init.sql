...
create table post_comments (id integer not null, text varchar(255) not null, time DATETIME not null, parent_id integer, post_id integer not null, user_id integer not null, primary key (id));
